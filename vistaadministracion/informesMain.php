        ...
        <div class="row align-items-start justify-content-evenly">
            <div class="col-4">
                ...
                <form method="POST" action="./informes/infoBarbero.php" target="_blank">
                    ...
                    <input type="submit" class="btn btn-primary d-block mx-auto m-2" value="Consultar por barbero">
                </form>
            </div>
            ...
            <div class="col-4">
                ...
                <form method="POST" action="./informes/infoServicio.php" target="_blank">
                    ...
                    <input type="submit" class="btn btn-primary d-block mx-auto my-2" value="Consultar por servicio">
                </form>
            </div>
            ...
            <div class="col-4">
                <form method="POST" action="./informes/infoFecha.php" target="_blank">
                    ...
                    <input type="submit" class="btn btn-primary d-block mx-auto mt-2" value="Consultar por fechas">
                </form>
            </div>
        </div>
    </section>
